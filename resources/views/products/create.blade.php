                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" id="purchase_price" name="purchase_price" min="0" 
                                    ...
                                    x-model="purchasePrice" @input="calculateProfit()">
                            </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" id="price" name="price" required min="1" 
                                    ...
                                    placeholder="50000"
                                    value="{{ old('price') }}"
                                    x-model="price" @input="calculatePayment(); calculateProfit()">
                            </div>
                            @error('price')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <div class="px-4 py-3 bg-gray-50 border border-gray-300 rounded-lg">
                                <span class="text-sm font-medium" x-text="formatPrice(profit)" :class="profit > 0 ? 'text-green-600' : 'text-gray-500'"></span>
                            </div>
    ...
    <script>
        function productForm() {
            return {
                ...
                calculateProfit() {
                    this.profit = (this.price || 0) - (this.purchasePrice || 0);
                },
