...
<aside 
    ...
    <nav class="flex-1 overflow-y-auto py-4 px-3">
        <div class="space-y-1">
            <!-- Dashboard -->
            <a href="{{ route('dashboard') }}" @click="closeMobileSidebar()" class="flex items-center px-4 py-3 rounded-lg {{ request()->routeIs('dashboard') ? 'bg-gradient-to-r from-blue-600 to-yellow-500 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }} transition-colors duration-200">
            ...
            @can('view_clients')
            <!-- Clients -->
            <a href="{{ route('clients.index') }}" @click="closeMobileSidebar()" class="flex items-center px-4 py-3 rounded-lg {{ request()->routeIs('clients.*') ? 'bg-gradient-to-r from-blue-600 to-yellow-500 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }} transition-colors duration-200">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            @can('view_tontines')
            <!-- Tontines -->
            <a href="{{ route('tontines.index') }}" @click="closeMobileSidebar()" class="flex items-center px-4 py-3 rounded-lg {{ request()->routeIs('tontines.*') ? 'bg-gradient-to-r from-blue-600 to-yellow-500 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }} transition-colors duration-200">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            @can('view_payments')
            <!-- Paiements -->
            <a href="{{ route('payments.index') }}" @click="closeMobileSidebar()" class="flex items-center px-4 py-3 rounded-lg {{ request()->routeIs('payments.*') ? 'bg-gradient-to-r from-blue-600 to-yellow-500 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }} transition-colors duration-200">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('reports.advanced') }}" @click="closeMobileSidebar()" class="flex items-center px-4 py-3 rounded-lg {{ request()->routeIs('reports.advanced*') ? 'bg-gradient-to-r from-blue-600 to-yellow-500 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }} transition-colors duration-200">
                ...
                <span class="ml-auto bg-gradient-to-r from-blue-500 to-purple-500 text-white text-xs px-2 py-1 rounded-full">NOUVEAU</span>
            </a>
            @endcan
            
            @if(auth()->user()->hasRole('secretary') || auth()->user()->hasRole('super_admin'))
            <!-- Gestion de Stock -->
            <a href="{{ route('stock.index') }}" @click="closeMobileSidebar()" class="flex items-center px-4 py-3 rounded-lg {{ request()->routeIs('stock.*') ? 'bg-gradient-to-r from-blue-600 to-yellow-500 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }} transition-colors duration-200">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"></path>
                </svg>
            ...
            <!-- Classement Agents -->
            <a href="{{ route('agents.ranking') }}" @click="closeMobileSidebar()" class="flex items-center px-4 py-3 rounded-lg {{ request()->routeIs('agents.ranking') ? 'bg-gradient-to-r from-blue-600 to-yellow-500 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }} transition-colors duration-200">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <!-- Réconciliation -->
            <a href="{{ route('reconciliation.index') }}" @click="closeMobileSidebar()" class="flex items-center px-4 py-3 rounded-lg {{ request()->routeIs('reconciliation.*') ? 'bg-gradient-to-r from-blue-600 to-yellow-500 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }} transition-colors duration-200">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path>
                </svg>
                <span class="font-medium">Anti-Fraude</span>
            </a>
            @endif
        </div>
