...
class Product extends Model
{
    ...
    {
        return $this->purchase_price ? number_format($this->purchase_price, 0, ',', ' ') . ' FCFA' : 'Non défini';
    }
    ...
    public function getFormattedCalculatedProfitAttribute()
    {
        $profit = $this->getCalculatedProfitAttribute();
        return $profit ? number_format($profit, 0, ',', ' ') . ' FCFA' : 'Non calculable';
    }
    
    public function getCalculatedProfitMarginAttribute()
    {
        if (!$this->purchase_price || $this->purchase_price == 0) return null;
